...
def _send_actuator_control_target():
    import main
...
def _send_message(msg_id, payload):
    global _seq
...
def _handle_message(msg_id, payload):
...
def _handle_manual_control(payload):
    import main
...
def _handle_param_request_list(payload):
...
def _handle_param_request_read(payload):
    from lib import parameters
...
def _send_param_value(name, value, index):
    from lib import parameters
...
def _handle_command_long(payload):
...
def _handle_set_actuator_control_target(payload):
    from lib import control
...
def _handle_serial_control(payload):
...
def _crc_accumulate(msg_id, crc):
